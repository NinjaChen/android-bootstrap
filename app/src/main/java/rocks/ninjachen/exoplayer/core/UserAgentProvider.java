...
import rocks.ninjachen.exoplayer.util.Strings;
 ...
 *
 *      tzpay/1.0 (Android 4.2.2; Genymotion Vbox86p / Generic Galaxy Nexus - 4.2.2 - API 17 - 720x1280; )[preload=false;locale=en_US;clientidbase=]
 *
...
public class UserAgentProvider implements Provider<String> {
    ...
    private static final String APP_NAME = "tzpay";
    ...
    public String get() {
        ...
        userAgent = "Android 4.4.4;Hezai/3.2.0(169); OPPO A31 / OPPO A31; [preload=false,locale=en_US,clientidbase=]";
        return userAgent;
    }
}
