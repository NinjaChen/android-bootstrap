...
public class ZeonicUtils {
    ...
    public static String getIdentification() {
        return "lalala";
//        return getIdentification(BootstrapApplication.getInstance().isApplicationBackground() ? ZeonicEncrypt.PhoneStatus.Background : ZeonicEncrypt.PhoneStatus.Running);
    }

//    public static String getIdentification(ZeonicEncrypt.PhoneStatus status) {
//        String phoneNumber = ZeonicLoginManager.getInstance().getLoggedUserName();
